                        ...
                        <div className="col-lg-3 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <div className="product-color mb-3">
                                ...
                                <ul className="list-unstyled">
                                    ...
                                    <li>
                                        <div className="product-color-item">
                                            <a href="#" className="text-dark"> <i className="fas fa-apple-alt text-secondary me-2"/> Green </a>
                                            <span>(1)</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="product-color-item">
                                            <a href="#" className="text-dark"> <i className="fas fa-apple-alt text-secondary me-2"/> White </a>
                                            <span>(1)</span>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div className="position-relative">
                                ...
                                <div className="text-center position-absolute d-flex flex-column align-items-center justify-content-center rounded p-4" style={{ width: "100%", height: "100%", top: 0, right: 0, background: "rgba(242, 139, 0, 0.3)" }} >
                                    <a href="#">
                    ...
                    <div className="tab-content">
                        <div id="tab-5" className="tab-pane fade show p-0 active">
                            <div className="row g-4 product">
                                {/*상품 리스트 목록 시작*/}
                                {products.map((item) => (
                                <div className="col-lg-4" key={item.prdId}>
